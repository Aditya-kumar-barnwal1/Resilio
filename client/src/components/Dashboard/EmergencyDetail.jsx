...
import { X, MapPin, Mic, ShieldCheck, Send, PlayCircle } from 'lucide-react';
  ...
  return (
    <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm z-[1000] flex items-center justify-center p-4">
      <div className="bg-white w-full max-w-4xl rounded-2xl shadow-2xl overflow-hidden flex flex-col md:flex-row h-[600px]">
        ...
        {/* Left Side: Visual Evidence (Cloudinary Image) */}
        <div className="md:w-1/2 bg-slate-200 relative">
          <img 
            // ✅ CHANGE 1: Direct Cloudinary URL (No BACKEND_URL needed)
        ...
        <div className="md:w-1/2 p-8 flex flex-col">
          ...
          <div className="space-y-6 flex-1 overflow-y-auto pr-2">
            ...
            {/* Voice Note Transcript / Description */}
